...
var Modal = function Modal(_ref) {
  ...
  var renderModalPortal = function renderModalPortal() {
    ...
    return _modalRoot.current && (0, _reactDom.createPortal)(_react.default.createElement("div", _extends({
      className: classes,
      ref: _modal
  ...
  return _react.default.createElement(_react.Fragment, null, trigger && (0, _react.cloneElement)(trigger, {
    onClick: showModal
  }), renderModalPortal());
};
...
Modal.propTypes = {
   ...
   */
  root: _propTypes.default.oneOfType([_propTypes.default.node, _propTypes.default.instanceOf(Element)])
};
Modal.defaultProps = {
